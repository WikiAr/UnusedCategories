...
class TestBuildCategoryPattern(unittest.TestCase):
    ...
    def test_arabic_category_pattern(self):
        ...
        self.assertIn('تصنيف', pattern)
        self.assertIn('علوم', pattern)
...
class TestCategoryInText(unittest.TestCase):
    ...
    def test_english_category_found(self):
        ...
        text = "هذا نص المقالة\n[[Category:Science]]"
        self.assertTrue(category_in_text(text, 'Science'))
    ...
    def test_multiple_categories(self):
        ...
        text = "[[تصنيف:علوم]]\n[[تصنيف:رياضيات]]\n[[تصنيف:فيزياء]]"
        self.assertTrue(category_in_text(text, 'علوم'))
        self.assertTrue(category_in_text(text, 'رياضيات'))
        self.assertTrue(category_in_text(text, 'فيزياء'))


class TestEnPageHasCategoryInText(unittest.TestCase):
    ...
    def test_category_with_prefix(self):
        ...
        text = "Article text\n[[Category:Science]]"
        self.assertTrue(en_page_has_category_in_text(text, 'Category:Science'))

    def test_category_without_prefix(self):
        """Test finding category when name doesn't include prefix."""
        text = "Article text\n[[Category:Science]]"
        self.assertTrue(en_page_has_category_in_text(text, 'Science'))
    ...
    def test_category_not_found(self):
        ...
        self.assertFalse(en_page_has_category_in_text(text, 'Science'))
    ...
    def test_multiple_categories(self):
        ...
        text = "[[Category:Science]]\n[[Category:Mathematics]]\n[[Category:Physics]]"
        self.assertTrue(en_page_has_category_in_text(text, 'Science'))
        self.assertTrue(en_page_has_category_in_text(text, 'Mathematics'))
        self.assertFalse(en_page_has_category_in_text(text, 'Chemistry'))


class TestIsArStubOrMaintenanceCategory(unittest.TestCase):
    ...
    def test_stub_category_with_prefix(self):
        ...
        self.assertTrue(is_ar_stub_or_maintenance_category('تصنيف:بذرة علوم'))

    def test_stub_category_without_prefix(self):
        """Test stub category starting with بذرة (without prefix)."""
        self.assertTrue(is_ar_stub_or_maintenance_category('بذرة رياضيات'))

    def test_stubs_category(self):
        """Test category containing بذور (stubs plural)."""
        self.assertTrue(is_ar_stub_or_maintenance_category('بذور العلوم'))
        self.assertTrue(is_ar_stub_or_maintenance_category('تصنيف:بذور الرياضيات'))

    def test_maintenance_category(self):
        """Test maintenance category containing صيانة."""
        self.assertTrue(is_ar_stub_or_maintenance_category('تصنيف:صيانة المقالات'))
        self.assertTrue(is_ar_stub_or_maintenance_category('صيانة'))

    def test_regular_category(self):
        """Test regular category (not stub or maintenance)."""
        self.assertFalse(is_ar_stub_or_maintenance_category('علوم'))
        self.assertFalse(is_ar_stub_or_maintenance_category('تصنيف:رياضيات'))
        self.assertFalse(is_ar_stub_or_maintenance_category('تصنيف:فيزياء'))
    ...
    def test_category_with_maintenance_in_middle(self):
        ...
        self.assertTrue(is_ar_stub_or_maintenance_category('مقالات صيانة منذ 2020'))


class TestIsEnStubOrMaintenanceCategory(unittest.TestCase):
    ...
    def test_stub_category_mixed_case(self):
        ...
        self.assertTrue(is_en_stub_or_maintenance_category('Category:Science Stub'))

    def test_maintenance_category_lowercase(self):
        """Test maintenance category with lowercase 'maintenance'."""
        self.assertTrue(is_en_stub_or_maintenance_category('Articles needing maintenance'))

    def test_maintenance_category_uppercase(self):
        """Test maintenance category with uppercase 'MAINTENANCE'."""
        self.assertTrue(is_en_stub_or_maintenance_category('MAINTENANCE CATEGORIES'))

    def test_maintenance_category_with_prefix(self):
        """Test maintenance category with Category: prefix."""
        self.assertTrue(is_en_stub_or_maintenance_category('Category:Wikipedia maintenance'))

    def test_regular_category(self):
        """Test regular category (not stub or maintenance)."""
        self.assertFalse(is_en_stub_or_maintenance_category('Science'))
        self.assertFalse(is_en_stub_or_maintenance_category('Category:Mathematics'))
        self.assertFalse(is_en_stub_or_maintenance_category('Physics'))

    def test_category_with_stub_substring(self):
        """Test that 'stub' is detected as substring."""
        self.assertTrue(is_en_stub_or_maintenance_category('Stubborn categories'))
